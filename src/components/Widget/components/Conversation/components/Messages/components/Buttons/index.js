...
import { parsePayload } from './helper';
...
class Buttons extends PureComponent {
    ...
    handleClick(reply) {
        ...
        /**
         * Parses the payload and will execute the onButtonAction 
         * if exists.
         */
        const parsedPayload = parsePayload(payload, this.props.onButtonAction);

        chooseReply(parsedPayload, title, id);
